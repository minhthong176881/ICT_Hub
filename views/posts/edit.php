...
?>
<form action="?controller=posts&action=postEdit&id=<?php echo $post->_id ?>" method="POST">
    ...
    <Textarea style="text-align: left; padding: 15px" class="content" rows="50" name="content" placeholder="Your post's content." id="post-content" required></Textarea>
    <br>
    <div class="btn-group" style="display: flex; margin-top: 20px;">
        <div style="margin-left: auto; margin-right: 95px">
            ...
            <button type="reset" onclick="window.location.href='?controller=posts&action=delete&id=<?php echo $post->_id ?>'" name="btn-submit" class="button-delete" style="width: 200px; margin-right: 20px">Delete</button>
