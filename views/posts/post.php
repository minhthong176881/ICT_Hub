<form action="" method="POST">
    ...
    <br>
    <input class="tag" type="text" name="tag" placeholder="Tag your post. Maximum 5 tags. At least 1 tag."><br>
    <Textarea class="content" placeholder="Your post's content."></Textarea>
    <br>
    <div class="btn-group" style="display: flex; margin-top: 20px;">
        <div style="margin-left: auto; margin-right: 95px">
            <button type="submit" class="button-login" style="width: 200px; margin-right: 20px">Submit</button>
